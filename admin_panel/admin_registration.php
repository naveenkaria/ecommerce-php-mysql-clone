        ...
        <div class="row d-flex justify-content-center ">
            ...
            <div class="col-lg-6 col-xl-5">
                <form action="" method="post">
                    ...
                    <div>
                        <input type="submit" class="bg-info py-2 px-3 border-0 text-light" name="admin_registration"
                            value="Register">
                        <p class="small fw-bold mt-2 pt-1">Already have an account <a href="admin_login.php"
                                class="link-denger">login</a></p>
                    </div>
                </form>
            </div>
        </div>
...
if (isset($_POST['admin_registration'])) {
    ...
    if ($rows_count > 0) {
        echo "<script>alert('This admin is already exists')</script>";
