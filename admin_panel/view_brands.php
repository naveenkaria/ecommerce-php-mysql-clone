    ...
    <tbody class='bg-secondary'>
        ...
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            <tr>
                ...
                <td><a href="index.php?delete_brand=<?php echo $brand_id ?>" type="button" class="btn btn-danger text-light"
                        data-toggle="modal" data-target="#exampleModal"><i class="fa-solid fa-trash"></i></td>
            </tr>
        <?php } ?>
    </tbody>
</table>
