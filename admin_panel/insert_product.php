...
if (isset($_POST["insert_product"])) {
    ...
    //images access tmp name
    $temp_image1 = $_FILES["product_image1"]['tmp_name'];
    $temp_image2 = $_FILES["product_image2"]['tmp_name'];
    $temp_image3 = $_FILES["product_image3"]['tmp_name'];

    if ($product_title == '' or $description == '' or $product_keywords == '' or $product_categories == '' or $product_brands == '' or $product_image1 == '' or $product_image2 == '' or $product_image3 == '') {
        ...
        values
        ('$product_title', '$description', '$product_keywords', '$product_categories', '$product_brands', '$product_image1', '$product_image2', '$product_image3', '$product_price', NOW(), '$product_status')";
...
<head>
    ...
    <title>Insert Product - E-Commerce - PHP - MYSQL - CLONE</title>
